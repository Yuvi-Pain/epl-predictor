...
Everything you need to work on the project: services, tests, migrations, the data loader, the worker, training, the API and the cache. For what the project is and why it's built this way, see the [README](../README.md).
